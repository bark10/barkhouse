...
core.register_chatcommand("me", {
	...
	func = function(name, param)
		core.chat_send_all(core.colorize("#6c66f6", "* " .. name .. " " .. param))
	end,
})
...
core.register_chatcommand("msg", {
	...
	func = function(name, param)
		...
		core.chat_send_player(sendto, core.colorize("#c0c0c0", "PM from " .. name .. ": "
				.. message))
		return true, core.colorize("#c0c0c0", "Sent PM to " ..sendto.. ".")
	end,
})
