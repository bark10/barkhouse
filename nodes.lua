...
minetest.register_node("barkhouse:powered_torch", {
	...
	inventory_image = "barkhouse_powered_torch_on_floor.png",
	wield_image = "barkhouse_powered_torch_on_floor.png",
	paramtype = "light",
...
minetest.register_node("barkhouse:floorboard_connector", {
	description = "Acacia Floorboard Connector",
	tiles = {"barkhouse_floorboard_connector.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node("barkhouse:floorboard", {
	description = "Acacia Floorboard",
	tiles = {"barkhouse_floorboard.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node(":default:acacia_wood", {
	description = "Acacia Wood",
	tiles = {"barkhouse_acacia_wood.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node(":default:wood", {
	description = "Wood",
	tiles = {"barkhouse_wood.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node(":default:aspen_wood", {
	description = "Aspen Wood",
	tiles = {"barkhouse_aspen_wood.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node(":default:junglewood", {
	description = "Jungle Wood",
	tiles = {"barkhouse_jungle_wood.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node(":default:pine_wood", {
	description = "Pine Wood",
	tiles = {"barkhouse_pine_wood.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
...
minetest.register_node(":default:jungletree", {
	...
	tiles = {"barkhouse_jungletree_top.png", "barkhouse_jungletree_top.png",
		"barkhouse_jungletree.png"},
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2},
	sounds = default.node_sound_wood_defaults(),
...
minetest.register_node("barkhouse:acacia_panel", {
	description = "Acacia Wood Panel",
	tiles = {"barkhouse_acacia_panel.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node("barkhouse:aspen_panel", {
...
minetest.register_node("barkhouse:aspen_panel", {
	...
	tiles = {"barkhouse_junglewood_panel.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node("barkhouse:pine_panel", {
	description = "Pinewood Panel",
	tiles = {"barkhouse_pine_panel.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})
minetest.register_node("barkhouse:wood_panel", {
	description = "Wood Panel",
	tiles = {"barkhouse_wood_panel.png"},
	groups = {choppy=2,oddly_breakable_by_hand=2,flammable=3,wood=1},
	sounds = default.node_sound_wood_defaults(),
})

minetest.register_node("barkhouse:cobble_brick", {
	description = "Cobblestone Brick",
	paramtype2 = "facedir",
	place_param2 = 0,
	tiles = {"barkhouse_cobble_brick.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("barkhouse:ironstone_cobble", {
	description = "Ironstone Cobble",
	paramtype2 = "facedir",
	place_param2 = 0,
	tiles = {"barkhouse_ironstone_cobble.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("barkhouse:cobble_weathered_brick", {
	description = "Weathered Cobblestone Brick",
	paramtype2 = "facedir",
	place_param2 = 0,
	tiles = {"barkhouse_cobble_weathered_brick.png"},
	is_ground_content = false,
	groups = {cracky = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_node("barkhouse:glossy_tile", {
	description = "Glossy Tile",
	paramtype2 = "facedir",
	use_texture_alpha = true,
	place_param2 = 0,
	tiles = {"barkhouse_glossy_tile.png"},
	is_ground_content = false,
	drawtype = "glasslike",
	sunlight_propagates = true,
	groups = {cracky = 2, stone = 1},
...
minetest.register_node("barkhouse:smoked_glass", {
